...
public class MigrationJobConfig {
    ...
    public Job migrationJob() {
        return new JobBuilder("migrationJob", jobRepository)
                ...
                .next(createChargeTargetCacheTasklet).next(chargeTargetMigrationStep).next(removeChargeTargetCacheTasklet)
                .next(createPaymentChannelCacheTasklet).next(paymentChannelMigrationStep).next(removePaymentChannelCacheTasklet)
